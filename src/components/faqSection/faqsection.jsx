...
const faqs = [
  {
    question: "Quels services proposez-vous pour la prise en charge de ma propriété ?",
    answer:
  ...
  {
    question: "Comment puis-je m'assurer que ma propriété sera bien entretenue ?",
    answer:
  ...
  {
    question: "Comment sont déterminées les tarifications pour la prise en charge de ma propriété ?",
    answer:
  ...
  {
    question: "Quelle est votre politique concernant les demandes spéciales des invités ?",
    answer:
    ...
    <section className="faq-section">
      <div className="faq-container">
        <div className="faq-image-container">
          <h2 className="faq-title">Les questions les plus fréquemment posées</h2>
